...
class TechRequestsApplicationTests {
    ...
    private final CreateRequest createRequest = new CreateRequest("Dators", "Darba", "vajag darbam", "izskata");
    @Test
    @Transactional
    @DisplayName("Spēj pievienot pieprasījumu")
    void addRequest(){
        Request request = service.createRequest(createRequest).getBody();
    ...
    void getAllRequests(){
        ...
        requests.add(service.createRequest(createRequest).getBody());
